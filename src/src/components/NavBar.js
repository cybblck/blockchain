        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="https://apblockchain.co.in/blockchain/" className={activeLink === 'blog' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('blog')}>Expertise</Nav.Link>
              ...
              <Nav.Link href="https://apblockchain.co.in/whyus" className={activeLink === 'what' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('what')}>What We Do?</Nav.Link>
